...
export default async function AdminDashboard() {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      icon: "📊",
      href: "/console/stats",
      description: "Portfolio metrics & achievements",
    },
    {
      label: "Process",
      icon: "🔄",
      href: "/console/process",
      description: "Your workflow process steps",
    },
    {
      label: "Tools",
      icon: "🛠️",
    ...
    },
    {
      ...
      description: "Homepage hero portrait URL",
    },
    {
      label: "Settings",
      icon: "⚡",
      href: "/console/settings",
      description: "Portfolio & account settings",
    },
  ];
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between border-b border-border/50 pb-6">
        <div>
          ...
          <p className="text-muted-foreground mt-2">
            Manage your portfolio content, projects, and settings
          </p>
        </div>
        <Button
          asChild
          ...
          {menuItems.slice(0, 7).map((item) => (
            <Link key={item.label} href={item.href}>
              <div className="group border border-border/50 hover:border-purple-500/50 rounded-lg p-6 bg-card/30 hover:bg-card/50 transition-all cursor-pointer h-full">
                ...
                <p className="text-xs text-purple-400 mt-4 group-hover:translate-x-1 transition-transform">
                  Manage →
                </p>
              </div>
            </Link>
      ...
      <div className="border border-border/50 rounded-lg p-8 bg-card/30 backdrop-blur-sm">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
          <Link href="/console/services" className="group">
            <Button
              variant="outline"
              className="w-full justify-start group-hover:bg-purple-500/10 group-hover:border-purple-500/50 transition"
            >
              <span className="mr-2">➕</span>
              Add Service
            </Button>
          </Link>
          <Link href="/console/projects" className="group">
            <Button
              variant="outline"
              className="w-full justify-start group-hover:bg-purple-500/10 group-hover:border-purple-500/50 transition"
            >
          ...
          <Link href="/console/testimonials" className="group">
            <Button
              variant="outline"
              className="w-full justify-start group-hover:bg-purple-500/10 group-hover:border-purple-500/50 transition"
            >
          ...
          <Link href="/console/contact" className="group">
            <Button
              variant="outline"
              className="w-full justify-start group-hover:bg-purple-500/10 group-hover:border-purple-500/50 transition"
            >
      ...
      <div className="border border-dashed border-purple-500/30 rounded-lg p-8 bg-purple-500/5">
        ...
        <p className="text-muted-foreground mb-6 max-w-2xl">
          Access documentation, API reference, or contact support for assistance
          managing your portfolio.
        </p>
        <div className="flex gap-4 flex-wrap">
          <Link href="/console/help/documentation">
            <Button
              variant="outline"
          ...
          <Link href="/console/help/api-reference">
            <Button
              variant="outline"
              className="hover:bg-purple-500/10 hover:border-purple-500/50"
            >
          ...
          <Link href="/console/help/support">
            <Button
              variant="outline"
              className="hover:bg-purple-500/10 hover:border-purple-500/50"
            >
