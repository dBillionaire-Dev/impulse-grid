...
export default function TestimonialsPage() {
  ...
  function openEditForm(t: any) {
    setEditingId(t.id)
    setFormData({ author: t.author, company: t.company, content: t.content, image: t.image ?? '' })
    setShowForm(true)
  }
    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-2">Manage client testimonials & reviews</p>
        </div>
        <Button
            ...
            >
              ...
              <div className="flex items-center justify-between pt-2">
                ...
                <div className="flex gap-2">
                  <Button onClick={() => openEditForm(t)} variant="outline" size="sm" className="border-border">
                    Edit
                  </Button>
                  <Button
