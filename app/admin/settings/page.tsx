...
import { getPortfolioContent, updatePortfolioContent } from '@/app/actions/portfolio'
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="border border-border/50 rounded-lg p-6 bg-card/30 backdrop-blur-sm space-y-6 max-w-2xl">
        <div>
          <label className="block text-sm font-medium text-foreground mb-2">Hero Title</label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-sm font-medium text-foreground mb-2">Hero Description</label>
          <textarea
